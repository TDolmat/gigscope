export function Footer() {
  ...
  return (
    <footer className="relative border-t border-blue-100/30 mt-16 sm:mt-32 bg-white/50 backdrop-blur-sm">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
        <div className="flex flex-col items-center gap-3 sm:flex-row sm:justify-between sm:gap-4">
          ...
          <p className="text-xs sm:text-sm text-gray-600">© {currentYear} GigScope. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
